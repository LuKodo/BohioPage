                    ...
                    <div className="card mb-4 rounded-3 shadow-sm position-relative">
                        ...
                        <div className="card-body">
                            ...
                            <div className="row mt-3 mb-0 pb-0">
                                ...
                                <div className="col border-end">
                                    <p className="fs-4 d-flex align-items-center mb-0">3 <span className="material-icons">shower</span></p>
                                    <small className="mt-0">Baños</small>
                                </div>
                                <div className="col">
                                    <p className="fs-4 d-flex align-items-center mb-0">164 <span className="material-icons">square_foot</span></p>
                                    <small className="mt-0 pt-0">m2</small>
                                </div>
                            </div>
                        </div>
                ...
                <div className="col">
                    <div className="card mb-4 rounded-3 shadow-sm position-relative">
                        ...
                        <div className="card-body">
                            ...
                            <div className="row mt-3 mb-0 pb-0">
                                <div className="col border-end">
                                    <p className="fs-4 d-flex align-items-center mb-0">0 <span className="material-icons">bed</span></p>
                                    <small className="mt-0">Habitaciones</small>
                                </div>
                                <div className="col border-end">
                                    <p className="fs-4 d-flex align-items-center mb-0">0 <span className="material-icons">shower</span></p>
                                    <small className="mt-0">Baños</small>
                                </div>
                                <div className="col">
                    ...
                    <div className="card mb-4 rounded-3 shadow-sm position-relative">
                        ...
                        <div className="card-body">
                            ...
                            <div className="row mt-3 mb-0 pb-0">
                                ...
                                <div className="col border-end">
                                    <p className="fs-4 d-flex align-items-center mb-0">2 <span className="material-icons">shower</span></p>
                                    <small className="mt-0">Baños</small>
                                </div>
                                <div className="col">
                                    <p className="fs-4 d-flex align-items-center mb-0">500 <span className="material-icons">square_foot</span></p>
